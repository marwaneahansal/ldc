...
export class AuthService {
  ...
  updateUserInfo(updatedUser: any): Observable<any> {
    return this.http
      .put(`${this.apiUrl1}/modifier/${updatedUser.id}`, updatedUser)
      .pipe(
        tap((response: any) => {
  ...
  updateClientInfo(updatedUser: any): Observable<any> {
    return this.http
      .put(`${this.apiUrl2}/modifier/${updatedUser.id}`, updatedUser)
      .pipe(
        tap((response: any) => {
          // Mettre à jour le BehaviorSubject avec les nouvelles informations
          this.userSubject.next(response);
  ...
  changePassword(data: {
    ...
    return this.http
      .put(`${this.apiUrl1}/${userId}/changer-mot-de-passe`, null, { params })
      .pipe(catchError(this.handleError));
  }
  ...
  changeClientPassword(data: {
    ...
    const params = new HttpParams()
      ...
      .set('nouveauMotDePasse', data.nouveauMotDePasse);
    return this.http
      .put(`${this.apiUrl2}/utilisateur/${userId}/changer-mot-de-passe`, null, { params })
      .pipe(catchError(this.handleError));
  }
